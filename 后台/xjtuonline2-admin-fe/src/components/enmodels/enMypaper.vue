            ...
            >
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">                       
                        <el-button type="primary" plain @click="edit2(scope.row)" size="small">修改</el-button>
...
created(){
        ...
        if(res.data.success == 1){
            ...
            for(let i=0; i<this.catagory.length; i++){
                ...
                // }
                    ...
                    if(this.catagory[i].catalog_role == 2){
                        this.erjimulu.push({
                            'cataname': this.catagory[i].catalog_name,
                            'cataid': this.catagory[i].id,
                        })
                    };
                    if(this.catagory[i].childrenRole == 1){
                        this.yijimulu.push({
                            'cataname': this.catagory[i].catalog_name,
                            'cataid': this.catagory[i].id,
                        })
    ...
    axios.get("/api/v1/admin/eSelfApply")
    .then(response => {
...
methods: {
    edit2(row){
        this.$router.push({name: 'tinymceEditor', query: {name: row.article_id, use: 'edit'}});
    },
    delete2(row){
